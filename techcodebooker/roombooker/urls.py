...
urlpatterns = [
    ...
    url(r'dashboard/rooms/(?P<id>[0-9]+)/calendar$',views_dash.show_calendar,name='show_calendar'),
    ...
    url(r'dashboard/rooms/([0-9]+)/calendar/populatecal$',views_calendar.populate, name='populatecal2'),
